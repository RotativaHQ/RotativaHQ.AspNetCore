...
namespace RotativaHQ.DotNetStandard
{
    ...
    public class RotativaHqClient
    {
        ...
        public string GetPdfUrl(HttpContext context, string switches, string html, string fileName = "", string header = "", string footer = "")
        {
                ...
                var task1 = Task.Run(async () => { await packageBuilder.AddHtmlToPackage(html, requestPath, "index"); });
                task1.Wait();
